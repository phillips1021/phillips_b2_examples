...
<p style="margin-bottom:15px">Note "un-merging" these courses will require assistance from a Blackboard system administrator.  Please be sure you want to merge these courses and have the parent
...
<form name="mainForm" method="post" action="SelectChildCoursesAction?course_id=${ctx.courseId.externalString}">
 ...
 <p><input type="submit" name="submit" value="Confirm Merge Courses" /></p>
